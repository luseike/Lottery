...
@interface LotteryPK10NumberPanCell()
...
@implementation LotteryPK10NumberPanCell
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        for (NSInteger i = 1 ; i < 11; i++) {
            ...
            [numberBtn setTitle:[NSString stringWithFormat:@"%02ld",(long)i] forState:UIControlStateNormal];
...
-(void)numberBtnClick:(UIButton *)numberBtn{
    if ([self.pk10Delegate respondsToSelector:@selector(PK10NumberPanCell:didSelectedNumberBtn:)]) {
        [self.pk10Delegate PK10NumberPanCell:self didSelectedNumberBtn:numberBtn];
    }
}

-(void)seperateBtnClick:(UIButton *)seperateBtn{
    if ([self.pk10Delegate respondsToSelector:@selector(PK10NumberPanCell:didSelectedSeperateBtn:)]) {
        [self.pk10Delegate PK10NumberPanCell:self didSelectedSeperateBtn:seperateBtn];
    }
}
