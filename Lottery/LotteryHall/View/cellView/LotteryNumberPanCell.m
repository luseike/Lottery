...
@interface LotteryNumberPanCell()
...
@implementation LotteryNumberPanCell
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        numberPanTypeLabel.font = [UIFont systemFontOfSize:12];
...
-(void)numberBtnClick:(UIButton *)numberBtn{
    ...
    if ([self.customDelegate respondsToSelector:@selector(NumberPanCell:didSelectedNumberBtn:)]) {
        [self.customDelegate NumberPanCell:self didSelectedNumberBtn:numberBtn];
    }
}

-(void)seperateBtnClick:(UIButton *)seperateBtn{
    if ([self.customDelegate respondsToSelector:@selector(NumberPanCell:didSelectedSeperateBtn:)]) {
        [self.customDelegate NumberPanCell:self didSelectedSeperateBtn:seperateBtn];
    }
}
